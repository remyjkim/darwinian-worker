...
test("incompatible duplicate skills inside one selected closure fail with Card provenance", async () => {
...
test("incompatible duplicate MCP definitions inside one selected closure fail", () => {
