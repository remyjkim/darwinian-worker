...
See the [extension skill bundles section](./reference/cli/library) and [npm skill bundles guide](https://github.com/remyjkim/darwinian-minds/blob/main/.ai/knowledges/03_npm-skill-bundles-guide.md) for the current surface.
