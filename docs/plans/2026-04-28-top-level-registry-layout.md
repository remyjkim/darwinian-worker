...
**Goal:** Move packaged darwinian-mind source data from root `config.json` and `mcp-servers.json` into `registry/` while preserving local `.agents/drwn/config.json` semantics.
...
- Create: `docs/assets/`
- Move: `the-darwinian-mind.png` to `docs/assets/the-darwinian-mind.png`
...
"files": [
  ...
  "skills",
  "README.md",
  "docs/assets/the-darwinian-mind.png",
  "LICENSE",
  "CONTRIBUTING.md"
]
```
